...
public class CookieController {
    ...
    private static final Set<String> ALLOWED_PLATFORMS = Set.of("boss", "liepin", "51job", "zhilian", "yupao");
    ...
    public ResponseEntity<Map<String, Object>> saveCookie(
        ...
        try {
            ...
            playwrightManager.saveCookiesToDb(currentUserService.requireUserId(), platform, remark);
            response.put("success", true);
