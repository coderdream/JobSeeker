...
public class StaticServerConfiguration {
    ...
    private boolean checkStaticResources() {
        ...
        boolean hasDist = hasContent(distPath) || new ClassPathResource("dist/index.html").exists();
        boolean hasStatic = hasContent(staticPath) || new ClassPathResource("static/index.html").exists();
