...
public class StaticResourceConfiguration implements WebMvcConfigurer {
    ...
    public void addResourceHandlers(ResourceHandlerRegistry registry) {
        ...
        boolean hasDistResources = Files.exists(distPath) || new ClassPathResource("dist/index.html").exists();
        boolean hasStaticResources = Files.exists(staticPath) || new ClassPathResource("static/index.html").exists();
