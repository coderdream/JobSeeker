...
public interface JobPlatformService {
     ...
     */
    void executeDelivery(Long userId, Consumer<JobProgressMessage> progressCallback);

    boolean startDeliveryAsync(Long userId, Executor executor, Consumer<JobProgressMessage> progressCallback);

    /**
     * 停止当前投递任务
     */
    void stopDelivery(Long userId);
